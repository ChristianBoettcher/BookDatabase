...
//-------------------------------------------------------------------------------------------------
        	if(hasGenre){
        		...
        		if(chckbxHorror.isSelected()){
            		...
            		sqlQuery.append(" Genre = ");
            		sqlQuery.append("'Horror'");
            		multiCondition = true;	
        		}
        		if(chckbxScififantacy.isSelected()){
        			if(multiCondition && hasGenre){
            			sqlQuery.append(" and (");
            			hasGenre = false; // a lazily recycled flag
            		} else if(multiCondition && !hasGenre){
            		...
            		sqlQuery.append(" Genre = ");
            		sqlQuery.append("'Sci-Fi/Fantasy'");
            		multiCondition = true;	
        		}
        		...
        		if(chckbxGraphicNovels.isSelected()){
            		...
            		sqlQuery.append(" Genre = ");
            		sqlQuery.append("'Graphic Novels'");
            		multiCondition = true;	
        		}
        		sqlQuery.append(" )");
        	}
//---------------------------------------------------------------------------------------------------------
        	if(hasPublisher){
        		if(chckbxPenguin.isSelected()){
        			if(multiCondition){
            			sqlQuery.append(" and (");
            			hasPublisher = false; // a lazily recycled flag
            		} else {
            			sqlQuery.append(" (");
            			hasPublisher = false; // a lazily recycled flag
            		}
        			sqlQuery.append(" PublisherName = ");
            		sqlQuery.append("'Penguin Books'");
            		multiCondition = true;
        		}
        		if(chckbxSchoolastic.isSelected()){
        			if(multiCondition && hasPublisher){
            			sqlQuery.append(" and (");
            			hasPublisher = false; // a lazily recycled flag
            		} else if(multiCondition && !hasPublisher){
            			sqlQuery.append(" or");
            		} else {
            			sqlQuery.append(" (");
            			hasPublisher = false; // a lazily recycled flag
        			...
        			sqlQuery.append(" PublisherName = ");
            		sqlQuery.append("'Scholastic'");
            		multiCondition = true;	
        		}
        		if(chckbxPearson.isSelected()){
        			if(multiCondition && hasPublisher){
            			sqlQuery.append(" and (");
            			hasPublisher = false; // a lazily recycled flag
            		} else if(multiCondition && !hasPublisher){
        			...
        			sqlQuery.append(" PublisherName = ");
            		sqlQuery.append("'Pearson'");
            		multiCondition = true;	
        		}
        		if(chckbxSimonAndSchuster.isSelected()){
        			if(multiCondition && hasPublisher){
            			sqlQuery.append(" and (");
            			hasPublisher = false; // a lazily recycled flag
            		} else if(multiCondition && !hasPublisher){
            		...
            		sqlQuery.append(" PublisherName = ");
            		sqlQuery.append("'Simon and Schuster'");
            		multiCondition = true;	
        		}
        		sqlQuery.append(" )");
        	}
//----------------------------------------------------------------------------------------------------------
    ...
    private void setBooleans(){
    	...
    	if(!(txtAuthorF.getText().equals(""))){
    		hasAuthorF = true; 
    	}
    	if(!(txtAuthorL.getText().equals(""))){
    		hasAuthorL = true; 
    	}
    	if(!(txtAuthorI.getText().equals(""))){
    		hasAuthorI = true; 
    	}
    	...
    	if(!(txtPublishingDate.getText().equals(""))){
    		hasPublishingDate = true; 
    	}
    	if(!(textField.getText().equals(""))){
    		hasKeyword = true; 
    	}
    	if(chckbxFiction.isSelected() || chckbxNonfiction.isSelected() ||
    			chckbxHorror.isSelected() || chckbxScififantacy.isSelected() ||
    			chckbxBiography.isSelected() || chckbxEducation.isSelected() ||
    			chckbxGraphicNovels.isSelected()){
    		hasGenre = true;
    	}
    	if(chckbxPenguin.isSelected() || chckbxSchoolastic.isSelected() ||
    			chckbxPearson.isSelected() || chckbxSimonAndSchuster.isSelected()){
    		hasPublisher = true;
    	}
