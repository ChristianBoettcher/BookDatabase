...
public class Gui {
    ...
    private void setUpTheFrame() {
        ...
        JLabel lblWelcomeToThe = new JLabel("Welcome to Daniel and Christian's BookStore Database");
        lblWelcomeToThe.setFont(new Font("Arial Black", Font.BOLD | Font.ITALIC, 12));
